"""Loader for benchmark_golden_pairs_1.jsonl -> structures consumed by benchmark_v0.

Usage:
    from benchmark_golden_pairs_1 import golden_pairs, should_refuse_map, answer_keys, pairs
"""
import json
